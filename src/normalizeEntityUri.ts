 ...
 */
function normalizeEntityUri<ItemType extends ResourceInterface, CollectionType extends CollectionInterface<ItemType, CollectionType>> (uriOrEntity: string | ResourceInterface | null = '', baseUrl = ''): string | null {
  let uri
